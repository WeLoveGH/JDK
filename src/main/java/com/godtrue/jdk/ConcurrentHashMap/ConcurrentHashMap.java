...
package com.godtrue.jdk.ConcurrentHashMap;
...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    ...
    static final int spread(int h) {
         ...
         * 1：将此对象的哈希值无符号右移16位
         * 2：将移位后的哈希值和原哈希值按位异或
         * 3：将 2 计算的结果和指定的哈希值进行按位与
         *
         * 其本质就是对哈希值进行一些操作，得到一个合适的哈希值，什么是合适的哈希值？就是分布均匀，冲突较少的哈希值
         *
         */
    ...
    final V putVal(K key, V value, boolean onlyIfAbsent) {
        /**
         * 不允许 key value 为 null，如果为 null ，则直接抛出空指针异常
         */
