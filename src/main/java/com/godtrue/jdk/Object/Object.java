...
package com.godtrue.jdk.Object;
...
public class Object {
    ...
    /**
     * 私有静态本地方法，用于注册本地对象，C/C++实现，具体做了什么事情，还需要看对应的源码
     */
    ...
    public boolean equals(Object obj) {
        /**
         * 从这里可以看到 equals() 方法的本质，就是进行对象引用的比对，凡是没有复写的子类，全部都是这个意思
         */
        return (this == obj);
    }
    ...
    public String toString() {
        /**
         * 从这里可以看到 toString() 方法的本质，就是打印此对象的全路径类名 + @ + 此对象的哈希值
         */
